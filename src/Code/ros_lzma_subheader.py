...
class ros_lzma_subheader(ros_header_v1):
    ...
    def __init__(self, time_stamp_sec, time_stamp_min, time_stamp_hour, time_stamp_day, time_stamp_month, time_stamp_year, size):

        self.time_stamp = struct.pack('<6B', time_stamp_sec, time_stamp_min, time_stamp_hour, self.UNKNOWN_TIME, time_stamp_day, time_stamp_month)  # 8 Bytes time stamp mit year big-endian
